          ...
          {[
            {
              ...
              category: "Специальная оценка условий труда · 120 рабочих мест",
              year: "2024",
              direction: "left",
            },
            {
              ...
              category: "Корпоративное обучение · 350 сотрудников",
              year: "2024",
              direction: "right",
            },
            {
              ...
              category: "Охрана труда под ключ · Строительная компания",
              year: "2023",
              direction: "left",
            },
          ].map((project, i) => (
